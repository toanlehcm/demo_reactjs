  ...
  return (
    <div className="dashboard-login-root">
      <div className="dashboard-login-bg">
        <svg className="dashboard-login-svg-bg" width="100%" height="100%" viewBox="0 0 1280 720" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg">
